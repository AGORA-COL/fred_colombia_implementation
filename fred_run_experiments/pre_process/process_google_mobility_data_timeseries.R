...
unique(google_data$sub_region_1)
unique(google_data$sub_region_2)
...
for(ct in 1:length(categories_google)){
   tmp_data_base = dplyr::filter(google_data, sub_region_1 == 'La Guajira', category == categories_google[ct])
