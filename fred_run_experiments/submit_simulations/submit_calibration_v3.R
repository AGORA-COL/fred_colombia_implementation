...
if(variants_in >= 0.5){    
    shelter_in_place_compliance_2 = c(0.75, 1.2)
    facemask_compliance_2         = c(0.75, 1.2)
    community_contact_rate_2_in   = c(0.75, 1.2)
}

if(variants_in >= 1){    
    shelter_in_place_compliance_3           = c(0.5, 1)
    facemask_compliance_3                   = c(0.5, 1)
    community_contact_rate_3_in             = c(1, 1.5)
...
if(variants_in >= 2){    
    shelter_in_place_compliance_4           = c(0.5, 1.)
    facemask_compliance_4                   = c(0.5, 1.)
    community_contact_rate_4_in             = c(1, 1.5)
...
if(variants_in >= 3){    
    shelter_in_place_compliance_5           = c(0.5, 1.)
    facemask_compliance_5                   = c(0.5, 1.)
    community_contact_rate_5_in             = c(1.0, 1.5)

    variantomicron_introduction_day_shift_in    = c(-30, 5)
    variantomicron_transmissibility_factor_in   = c(1.25, 4.00) #c(3.12, 3.38)1.25
    variantomicron_severity_factor_in           = c(0.56, 1.52)
    variantomicron_cross_protection_prob_in     = c(0.2, 0.7) #c(0.1, 0.6)
    variantomicron_introduction_day_in          = c(as.numeric(as.Date('2021-11-01') - as.Date('2020-01-01')),as.numeric(as.Date('2021-12-20') - as.Date('2020-01-01')))
