...
if(variants_in >= 3){    
    shelter_in_place_compliance_5           = c(0.2, 1.5)
    facemask_compliance_5                   = c(0.2, 1.5)
    community_contact_rate_5_in             = c(0.2, 1.5)

    variantomicron_introduction_day_shift_in    = c(-15, 15)
    variantomicron_transmissibility_factor_in   = c(1.25, 4.00) #c(3.12, 3.38)1.25
    variantomicron_severity_factor_in           = c(0.56, 1.52)
    variantomicron_cross_protection_prob_in     = c(0.1, 0.5)
    variantomicron_introduction_day_in          = c(as.numeric(as.Date('2021-11-01') - as.Date('2020-01-01')),as.numeric(as.Date('2021-12-20') - as.Date('2020-01-01')))
    variantomicron_imports_factor_in            = c(0.1, 1.5)
}
